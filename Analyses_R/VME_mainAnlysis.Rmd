...
* **trial_num**: index of the trial in the experiment (includes all trials from all blocks; also training)
    "perception" block: 11-82  
    vSTM block ("experiment"): 93-812  
* **block_num**: index of the block 
* **c_StimN**: number of memory items (2 or 4)  
* **c_Ecc**: stimulus eccentricity (4, 9, 14)  
