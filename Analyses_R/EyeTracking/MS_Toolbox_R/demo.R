...
source("EyeTracking/MS_Toolbox_R/smoothdata.R")
source("EyeTracking/MS_Toolbox_R/surrogate.R")
source("EyeTracking/MS_Toolbox_R/lagdist.R")
source("EyeTracking/MS_Toolbox_R/boxcount.R")
source("EyeTracking/MS_Toolbox_R/sacpar.R")
par(ask = TRUE)
...
d <- read.table("EyeTracking/MS_Toolbox_R/data/f01.005.dat")
