...
func_analysis_05 <- function(dep_variable = "CDA_amp_clustertimes") {
  ...
  extract_var(str_c("cda_exp_", time_win_str, "Ecc_4_StimN2vsStimN4_p"), res_ttest_perEcc$p[res_ttest_perEcc$c_Ecc == 4], is_pval=TRUE, exp_format = "%.3f")
  extract_var(str_c("cda_exp_", time_win_str, "Ecc_9_StimN2vsStimN4_p"), res_ttest_perEcc$p[res_ttest_perEcc$c_Ecc == 9], is_pval=TRUE, exp_format = "%.3f")
  extract_var(str_c("cda_exp_", time_win_str, "Ecc_14_StimN2vsStimN4_p"), res_ttest_perEcc$p[res_ttest_perEcc$c_Ecc == 14], is_pval=TRUE, exp_format = "%.3f")
