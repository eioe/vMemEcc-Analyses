...
variable_doc[["alphapwr_global_sigloadcluster"]] <- 
  "Mean induced alpha power (non-lateralized) in electrode POz; averaged across timepoints for whcih we found a sign. difference between the memory conditions (as assessed by a CBP test)"
...
variable_doc[["maxDecodScoreTime_csp"]] <- 
