...
source(here("Workflow_Sven", "osf_experiment1", "_RScripts", "loadColors.R"))
```

```{r, include=F, message=F}

# set data choices:
write_fulldat_to_disk <- FALSE # TRUE
get_fulldat_from_disk <- TRUE # FALSE
get_data_from_sdrive <- FALSE # TRUE
